const italian = {
  ...
  slidingPuzzle: "Puzzle scorrevole {rows} per {columns}",
  ...
  noMessages: "Nessun messaggio. Scrivi qualcosa al tuo amico.",
  messagePlaceholder: "Scrivi un messaggio",
  sendMessage: "Invia messaggio",
  you: "Tu",
  friend: "Amico",
  unreadMessages: "{count} messaggi non letti",
  startVoice: "Attiva voce",
  retryVoice: "Riprova voce",
  stopVoice: "Lascia voce",
  muteMicrophone: "Disattiva microfono",
  unmuteMicrophone: "Riattiva microfono",
  microphoneMuted: "Microfono spento",
  microphoneOn: "Microfono acceso",
  voiceIdle: "Voce non attiva",
  voiceRequesting: "Accesso al microfono...",
  voiceWaiting: "In attesa del tuo amico",
...
const english: Dictionary = {
  ...
  slidingPuzzle: "{rows} by {columns} sliding puzzle",
  moveTile: "Move tile",
  ...
  noMessages: "No messages yet. Say something to your friend.",
  ...
  stopVoice: "Leave voice",
  muteMicrophone: "Mute microphone",
  unmuteMicrophone: "Unmute microphone",
  microphoneMuted: "Microphone muted",
  microphoneOn: "Microphone on",
  voiceIdle: "Voice is off",
  voiceRequesting: "Accessing microphone...",
  voiceWaiting: "Waiting for your friend",
